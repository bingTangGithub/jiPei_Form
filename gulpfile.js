...
gulp.task('dev', function() {
    ...
    new webpackDevServer(compiler, {
        ...
        open('http://localhost:' + defaultSettings.port + '/jipei-statementsPages/Test/index.html');
    })
});
...
gulp.task('checkPrebuild', ['prebuild', 'copyPrebuildFiles'], function() {
    ...
    return deferedCheckPrebuild(function() {
        sendEmail({
            subject: 'jipei-statements build task has been successfully completed on master branch.',
            html: '<p>Project jipei-statements will be updated in a minute; Have a nice day! ;D  --sent from John </p>'
        });
    }, function() {
        defered.reject();
    });
