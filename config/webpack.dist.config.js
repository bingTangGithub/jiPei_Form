...
var webpackConfig = {
  ...
  module: {
    loaders: [
      ...
      {
        test: /\.less$/,
        loader: ExtractTextPlugin.extract('css!less?{"modifyVars":{"primary-color":"#F8CF00","heading-color":"fade(#000, 100%)","text-color":"fade(#000, 85%)","text-color-secondary":"fade(#000, 65%)"}}')
      },
      {
        test: /\.scss/,
